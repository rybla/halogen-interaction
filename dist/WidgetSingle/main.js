...
(() => {
  ...
  // output/Halogen.Interaction.Interpretation.WidgetSingle/index.js
    ...
    return {
      map: function(f) {
        return function(m) {
          ...
          ;
          throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.WidgetSingle (line 0, column 0 - line 0, column 0): " + [m.constructor.name]);
        };
      }
    };
  };
  ...
  var run3 = function(v) {
    return runFreeM2(function(v1) {
        ...
        var wc = function() {
          ...
          var $$eval = mkEval({
            ...
            handleAction: function(v3) {
              ...
              ;
              throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.WidgetSingle (line 105, column 26 - line 108, column 56): " + [v3.constructor.name]);
            }
          });
          return mkComponent({
            initialState,
      ...
      ;
      throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.WidgetSingle (line 55, column 75 - line 114, column 40): " + [v1.constructor.name]);
    })(v);
  };
  ...
  var appComponent = /* @__PURE__ */ function() {
    ...
    var $$eval = mkEval({
      ...
      handleAction: function(v1) {
        ...
        ;
        throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.WidgetSingle (line 170, column 22 - line 180, column 20): " + [v1.constructor.name]);
      }
    });
    return mkComponent({
      initialState,
