...
(() => {
      ...
      return function(k) {
        var go2 = function(f) {
          ...
          if (v instanceof Return) {
            return map23(Done.create)(pure14(v.value0));
          }
          ;
  ...
  // output/Halogen.Interaction.Interaction/index.js
  ...
  var functorInteractionT = freeFunctor;
        ...
        map: function(f) {
          return function(m) {
            if (m instanceof Lift3) {
              return new Lift3(map20(f)(m.value0));
            }
            ;
            ...
            ;
            throw new Error("Failed pattern match at Halogen.Interaction.Interaction (line 0, column 0 - line 0, column 0): " + [m.constructor.name]);
          };
        }
      };
    };
  ...
  var evalQ = function(render) {
    return function(ref3) {
      return function(q2) {
        return bind12(liftEffect4(read(ref3)))(function(v) {
          return evalM(render)(ref3)(v["component"]["eval"](new Query(map13(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
  ...
  // output/Halogen.Interaction.Interpretation.PointAndClickAdventure/index.js
  ...
  var tell3 = /* @__PURE__ */ tell2()(consoleIsSymbol)(ordUnit);
  ...
  var slot_2 = /* @__PURE__ */ slot_()(consoleIsSymbol)(ordUnit);
  ...
  var ClearPrompt = /* @__PURE__ */ function() {
    function ClearPrompt2(value0) {
      this.value0 = value0;
    }
    ;
    ClearPrompt2.create = function(value0) {
      return new ClearPrompt2(value0);
    };
    return ClearPrompt2;
  }();
  var AddConsoleLog = /* @__PURE__ */ function() {
    function AddConsoleLog2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    AddConsoleLog2.create = function(value0) {
      return function(value1) {
        return new AddConsoleLog2(value0, value1);
      };
    };
    return AddConsoleLog2;
  }();
  ...
  var WidgetOutput = function(x) {
    return x;
  };
  var AddConsoleLog_ConsoleQuery = /* @__PURE__ */ function() {
    function AddConsoleLog_ConsoleQuery2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    AddConsoleLog_ConsoleQuery2.create = function(value0) {
      return function(value1) {
        return new AddConsoleLog_ConsoleQuery2(value0, value1);
      };
    };
    return AddConsoleLog_ConsoleQuery2;
  }();
  var WidgetOutput_AppAction = /* @__PURE__ */ function() {
    function WidgetOutput_AppAction2(value0) {
      this.value0 = value0;
    }
    ;
    WidgetOutput_AppAction2.create = function(value0) {
      return new WidgetOutput_AppAction2(value0);
    };
    return WidgetOutput_AppAction2;
  }();
  var Noop_AppAction = /* @__PURE__ */ function() {
    function Noop_AppAction2() {
    }
    ;
    Noop_AppAction2.value = new Noop_AppAction2();
    return Noop_AppAction2;
  }();
  var functorF = function(dictFunctor) {
    var map23 = map(dictFunctor);
    return {
      map: function(f) {
        return function(m) {
          if (m instanceof Prompt) {
            return new Prompt(m.value0, map18(map23(f))(m.value1));
          }
          ;
          if (m instanceof ClearPrompt) {
            return new ClearPrompt(map18(map23(f))(m.value0));
          }
          ;
          if (m instanceof AddConsoleLog) {
            return new AddConsoleLog(m.value0, map18(map23(f))(m.value1));
          }
          ;
          if (m instanceof SetScene) {
            return new SetScene(m.value0, map18(map23(f))(m.value1));
          }
          ;
          throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.PointAndClickAdventure (line 0, column 0 - line 0, column 0): " + [m.constructor.name]);
        };
      }
    };
  };
  var runFreeM2 = /* @__PURE__ */ runFreeM(/* @__PURE__ */ functorInteractionF(functorAff)(/* @__PURE__ */ functorF(functorAff)))(monadRecHalogenM);
  var setScene = function(dictApplicative) {
    var pure42 = pure(dictApplicative);
    return function(wc) {
      return liftF(new Interact(new SetScene(wc, pure42)));
    };
  };
  var setScene1 = /* @__PURE__ */ setScene(applicativeAff);
  var promptComponent = function(msg) {
    return function(k) {
      var render = function(v) {
        return div2([classes(["Widget"])])(fold2([[div2([])([fromPlainHTML(msg)])], [div2([])([input([ref2("input")])])], [div2([])([button([onClick($$const(new Right(unit)))])([text5("submit")])])]]));
      };
      ...
      var $$eval = mkEval({
        ...
        handleAction: function(v1) {
          ...
          ;
          if (v1 instanceof Right) {
            return bind6(mapFlipped2(getHTMLElementRef("input"))(fromMaybe$prime(function(v2) {
              return bug("impossible, since input must exist");
            })))(function(inputElement) {
              return bind6(liftEffect7(value3(fromMaybe$prime(function(v2) {
          ...
          ;
          throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.PointAndClickAdventure (line 151, column 22 - line 156, column 41): " + [v1.constructor.name]);
        }
      });
      return mkComponent({
        initialState,
  ...
  var run3 = function(v) {
    return runFreeM2(function(v1) {
      if (v1 instanceof Lift3) {
        return lift3(v1.value0);
      }
      ;
      if (v1 instanceof Interact && v1.value0 instanceof AddConsoleLog) {
        return discard12(tell3($$Proxy.value)(unit)(AddConsoleLog_ConsoleQuery.create(v1.value0.value0)))(function() {
          return lift3(v1.value0.value1(unit));
        });
      }
      ;
      if (v1 instanceof Interact && v1.value0 instanceof Prompt) {
        return discard12(modify_3(function(st) {
          ...
          ;
          $133.mb_prompt = pure10(promptComponent(v1.value0.value0)(v1.value0.value1));
          $133.prompt_id = st.prompt_id + 1 | 0;
          return $133;
        }))(function() {
          return pure13(pure23(unit));
        });
      }
      ;
      if (v1 instanceof Interact && v1.value0 instanceof ClearPrompt) {
        return discard12(modify_3(function(st) {
          var $139 = {};
          for (var $140 in st) {
          ...
          ;
          $139.mb_prompt = empty7;
          return $139;
        }))(function() {
          return lift3(v1.value0.value0(unit));
        });
      }
      ;
      if (v1 instanceof Interact && v1.value0 instanceof SetScene) {
        return discard12(modify_3(function(st) {
          ...
          ;
          $144.scene = v1.value0.value0;
          $144.scene_id = st.scene_id + 1 | 0;
          return $144;
        }))(function() {
          return pure13(pure23(unit));
        });
      ...
      ;
      throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.PointAndClickAdventure (line 227, column 75 - line 240, column 21): " + [v1.constructor.name]);
    })(v);
  };
  var prompt = function(dictApplicative) {
    var pure42 = pure(dictApplicative);
    return function(msg) {
      return liftF(new Interact(new Prompt(msg, pure42)));
    };
  };
  var consoleComponent = /* @__PURE__ */ function() {
    var render = function(v) {
      return div3([classes(["Console"])])(mapWithIndex2(function(i2) {
        return function(log1) {
          return new Tuple(show2(i2), div2([classes(["ConsoleLog"])])([fromPlainHTML(log1)]));
        };
      })(v.logs));
    };
    var initialState = function(v) {
    ...
    var $$eval = mkEval({
      ...
      handleQuery: function(v1) {
        return discard12(modify_3(function(st) {
          ...
          ;
          $154.logs = append5(st.logs)([v1.value0]);
          return $154;
        }))(function() {
          return pure13(pure10(v1.value1));
        });
      }
    });
    return mkComponent({
  ...
  var clearPrompt = function(dictApplicative) {
    return liftF(new Interact(new ClearPrompt(pure(dictApplicative))));
  };
  var clearPrompt1 = /* @__PURE__ */ clearPrompt(applicativeAff);
  var exampleScene = /* @__PURE__ */ function() {
    var render = function(v) {
      return div2([classes(["Scene"]), style("background-color: pink;")])([text5("this is an example scene")]);
    };
    var initialState = function(v) {
      return {};
    };
    var $$eval = mkEval({
      ...
      receive: defaultEval.receive,
      finalize: defaultEval.finalize,
      initialize: pure10(inj2($$Proxy.value)(discard23($$void(functorInteractionT)(prompt(applicativeAff)(text5("what do you think of the new scene?"))))(function() {
        return clearPrompt1;
      }))),
      handleAction: match2({
        effect: function($173) {
          return raise(WidgetOutput(pure32(unwrap4($173))));
        }
      })
    });
    return mkComponent({
  ...
  var addConsoleLog = function(dictApplicative) {
    var pure42 = pure(dictApplicative);
    return function(msg) {
      return liftF(new Interact(new AddConsoleLog(msg, pure42)));
    };
  };
  var addConsoleLog1 = /* @__PURE__ */ addConsoleLog(applicativeAff);
  var initialScene = function(start1) {
    var initialState = function(v) {
      return {};
    };
    var $$eval = mkEval({
      ...
      handleAction: match2({
        effect: function($174) {
          return raise(WidgetOutput(pure32(unwrap4($174))));
        }
      })
    });
    var render = function(v) {
      return div2([classes(["Scene"]), style("background-color: lightblue;")])([button([onClick($$const(inj2($$Proxy.value)(discard23(addConsoleLog1(text5("clicked 'start'")))(function() {
        return discard23(start1)(function() {
          return discard23(addConsoleLog1(text5("setting scene to example scene now ...")))(function() {
            return setScene1(exampleScene);
          });
        });
      }))))])([text5("start")]), button([onClick($$const(inj2($$Proxy.value)(addConsoleLog1(text5("clicked 'settings'")))))])([text5("settings")]), button([onClick($$const(inj2($$Proxy.value)(addConsoleLog1(text5("clicked 'quite'")))))])([text5("quit")])]);
    };
    return mkComponent({
      initialState,
      "eval": $$eval,
  ...
  var appComponent = /* @__PURE__ */ function() {
    var render = function(v) {
      return div2([classes(["App"])])(fold2([[slot1($$Proxy.value)(v.scene_id)(v.scene)({})(WidgetOutput_AppAction.create)], map19(function(wc) {
        return slot22($$Proxy.value)(v.prompt_id)(wc)({})(WidgetOutput_AppAction.create);
      })(fromFoldable3(v.mb_prompt)), [slot_2($$Proxy.value)(unit)(consoleComponent)({})]]));
    };
    var initialState = function(v) {
      return {
        start: v.start,
        scene: initialScene(v.start),
        scene_id: 0,
        mb_prompt: empty7,
        prompt_id: 0
      };
      ...
      handleAction: function(v1) {
        if (v1 instanceof WidgetOutput_AppAction) {
          return discard12(log4("appComponent.eval.handleAction.WidgetOutput_AppAction"))(function() {
            return bind6(liftAff2(v1.value0))(function(fiu) {
        ...
        ;
        throw new Error("Failed pattern match at Halogen.Interaction.Interpretation.PointAndClickAdventure (line 287, column 22 - line 294, column 20): " + [v1.constructor.name]);
      }
    });
    return mkComponent({
      initialState,
  ...
  var start2 = function(dictApplicative) {
    ...
    var addConsoleLog2 = addConsoleLog(dictApplicative);
    var clearPrompt2 = clearPrompt(dictApplicative);
    return bind15(prompt1(text5("name: ")))(function(name15) {
      return discard23(addConsoleLog2(text5("greetings, " + name15)))(function() {
        return bind15(prompt1(text5("favorite color: ")))(function(color) {
          return discard23(addConsoleLog2(text5(name15 + ("'s favorite color is " + color))))(function() {
            return clearPrompt2;
          });
        });
      });
